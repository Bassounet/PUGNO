class Tableau00 extends Tableau{
    ...
    create() {
        ...
        //des étoiles
        this.star1=this.physics.add.sprite(200,100,"medikit_1");
        this.star1.setCollideWorldBounds(true);
        this.star1.setBounce(0);

        this.star2=this.physics.add.sprite(400,100,"medikit_1");
        this.star2.setCollideWorldBounds(true);
        this.star2.setBounce(0.5);

        this.star3=this.physics.add.sprite(600,100,"medikit_1");
    ...
    } /* ___________________ on se fait un petit test pour le tir ______________________________________ */
