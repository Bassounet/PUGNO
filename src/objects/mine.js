class mine extends ObjetPhysique{
    ...
    constructor(scene, x, y,image) {
        ...
        this.antenne = this.scene.add.pointlight(this.x - 14, this.y -20, 0xff0000, 11, 10, 5);
        this.antenne2 = this.scene.add.pointlight(this.x + 14, this.y -20 , 0xff0000, 11, 10, 5);
        this.antenne2.attenuation = 0.03;
        this.antenne2.color.setTo(255, 0, 0);
        this.antenne.attenuation = 0.03;
